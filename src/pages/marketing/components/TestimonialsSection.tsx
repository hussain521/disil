...
export default function TestimonialsSection() {
  ...
  return (
    <section
      id="testimonials"
      className="relative overflow-hidden bg-slate-50 dark:bg-slate-950 py-10 sm:py-14 transition-colors duration-200 border-t border-gray-200/80 dark:border-gray-800/80 transform-gpu"
    >
