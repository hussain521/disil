...
export default function CompanyLogin() {
  ...
  return (
    <main className="relative flex min-h-screen w-full items-center justify-center overflow-hidden bg-slate-50 dark:bg-slate-950 text-slate-900 dark:text-slate-100 selection:bg-amber-500 selection:text-slate-950 font-sans transition-colors duration-200">
      {/* Dynamic Background Glows & Patterns */}
      <div className="pointer-events-none absolute -top-40 -left-40 h-[32rem] w-[32rem] rounded-full bg-blue-500/10 dark:bg-blue-600/20 blur-[130px]" />
      <div className="pointer-events-none absolute -bottom-40 -right-40 h-[36rem] w-[36rem] rounded-full bg-amber-500/10 dark:bg-amber-500/15 blur-[150px]" />
      <div className="pointer-events-none absolute inset-0 bg-[radial-gradient(circle_at_center,rgba(15,23,42,0.05)_1px,transparent_1px)] dark:bg-[radial-gradient(circle_at_center,rgba(255,255,255,0.03)_1px,transparent_1px)] bg-[size:32px_32px] opacity-40" />

      {/* Top Header Utilities */}
      <header className="absolute top-6 left-6 right-6 flex items-center justify-between z-20">
        <Link
          to="/"
          className="group inline-flex items-center gap-2 rounded-full border border-slate-200 dark:border-slate-800 bg-white/80 dark:bg-slate-900/80 px-4 py-2 text-xs font-semibold text-slate-700 dark:text-slate-300 backdrop-blur-md transition-all hover:border-slate-300 dark:hover:border-slate-700 hover:bg-slate-100 dark:hover:bg-slate-800 hover:text-slate-900 dark:hover:text-white"
        >
      ...
      <div className="relative z-10 w-full max-w-md px-4 py-12">
        <div className="overflow-hidden rounded-3xl border border-slate-200 dark:border-slate-800/80 bg-white/90 dark:bg-slate-900/90 p-8 sm:p-10 shadow-xl dark:shadow-2xl dark:shadow-black/80 backdrop-blur-xl transition-all duration-300 hover:border-slate-300 dark:hover:border-slate-700/80">
          
          {/* Logo & Portal Badge */}
          <div className="flex flex-col items-center text-center">
            <div className="relative mb-4 flex h-16 w-16 items-center justify-center rounded-2xl border border-amber-500/30 bg-gradient-to-br from-amber-500/20 via-slate-100 dark:via-slate-800 to-slate-200 dark:to-slate-900 shadow-inner shadow-amber-500/20">
              <Building2 className="h-8 w-8 text-amber-600 dark:text-amber-400 drop-shadow-[0_0_8px_rgba(245,158,11,0.5)]" />
              <div className="absolute -top-1 -right-1 flex h-4 w-4 items-center justify-center rounded-full bg-blue-500 ring-2 ring-white dark:ring-slate-950">
                <Truck className="h-2.5 w-2.5 text-white" />
              </div>
            </div>

            <div className="inline-flex items-center gap-1.5 rounded-full border border-amber-500/30 bg-amber-500/10 px-3 py-1 text-[11px] font-bold tracking-wider text-amber-600 dark:text-amber-300 uppercase mb-3">
          ...
          <form className="mt-8 space-y-4" onSubmit={handleSubmit}>
            <div>
              <label htmlFor="phone" className="mb-1.5 block text-xs font-bold uppercase tracking-wider text-slate-700 dark:text-slate-300">
                {t('company.login.phoneLabel', t('auth.phoneLabel', 'Phone Number'))}
              </label>
              <div className="relative">
                <div className="pointer-events-none absolute inset-y-0 left-0 rtl:left-auto rtl:right-0 flex items-center pl-3.5 rtl:pl-0 rtl:pr-3.5 text-slate-400 dark:text-slate-500">
                ...
                <input
                  ...
                  dir="ltr"
                  className="w-full rounded-xl border border-slate-200 dark:border-slate-800 bg-slate-50 dark:bg-slate-950/70 py-3 pl-10 pr-4 rtl:pl-4 rtl:pr-10 text-sm font-medium text-slate-900 dark:text-white placeholder-slate-400 dark:placeholder-slate-600 transition-all focus:border-amber-500 focus:bg-white dark:focus:bg-slate-950 focus:outline-none focus:ring-4 focus:ring-amber-500/15"
                />
              </div>
            </div>
            ...
            {error && (
              <div className="animate-shake rounded-xl border border-rose-500/30 bg-rose-500/10 p-3 text-xs font-medium text-rose-600 dark:text-rose-400 flex items-start gap-2">
          ...
          <div className="mt-8 border-t border-slate-200 dark:border-slate-800/80 pt-6">
            <div className="grid grid-cols-2 gap-2 text-center">
              <div className="flex items-center justify-center gap-1.5 rounded-lg bg-slate-100 dark:bg-slate-950/40 py-2 px-2 text-[11px] font-medium text-slate-600 dark:text-slate-400">
